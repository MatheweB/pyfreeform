...
def generate():
    ...
    cell.add_rect(at=(0.5, 0.43), width=0.38, height=0.38,
        ...
        .spin(360, duration=2.5, repeat=True, easing="linear")
    cell.add_text(".spin(360, repeat=True)", at=(0.5, 0.88),
                  font_size=0.065, color="gray")
    ...
    cell.add_dot(at=(0.5, 0.43), radius=0.06, color="coral") \
        .animate("r", to=35, duration=1.2, easing="ease-in-out",
                 repeat=True, bounce=True)
    cell.add_text('.animate("r", to=35, bounce=True)', at=(0.5, 0.88),
    ...
    cell.add_dot(at=(0.5, 0.43), radius=0.08, color="tomato") \
        .zoom(to=2.0, duration=2.0, easing="ease-in-out",
              bounce=True, repeat=True)
    cell.add_text(".zoom(to=2.0, bounce=True)", at=(0.5, 0.88),
                  font_size=0.065, color="gray")
    ...
    p1.move(to=(0.2, 0.28), duration=2.0, bounce=True, repeat=True,
            easing="ease-in-out")
    p2.move(to=(0.16, 0.58), duration=2.0, bounce=True, repeat=True,
            easing="ease-in-out")
    p3.move(to=(0.48, 0.58), duration=2.0, bounce=True, repeat=True,
            easing="ease-in-out")
    p4.move(to=(0.52, 0.28), duration=2.0, bounce=True, repeat=True,
            easing="ease-in-out")
    ...
    d1.move(to=(0.75, 0.7), duration=2.5, bounce=True, repeat=True,
            easing="ease-in-out")
    d2.move(to=(0.8, 0.18), duration=2.5, bounce=True, repeat=True,
            easing="ease-in-out")

    cell.add_text("vertices + endpoints react to .move()", at=(0.5, 0.92),
                  font_size=0.06, color="gray")
    ...
    cell.add_dot(at=(0.43, 0.43), radius=0.025, color="coral") \
        .animate("r", to=28, duration=1.5, easing="ease-in-out",
                 repeat=True, bounce=True)
    ...
    for i, c in enumerate(sq_colors):
        ...
        cell.add_rect(at=(rx, 0.93), width=0.03, height=0.045,
                      fill=c) \
            .spin(360, duration=1.5 + i * 0.3, repeat=True, easing="linear")
