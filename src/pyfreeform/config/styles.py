...
class DotStyle:
    ...
    def with_radius(self, radius: float) -> DotStyle:
        ...
        return DotStyle(radius=radius, color=self.color, z_index=self.z_index)
    
    def with_color(self, color: str) -> DotStyle:
        """Return new style with different color."""
        return DotStyle(radius=self.radius, color=color, z_index=self.z_index)
    
    def with_z_index(self, z_index: int) -> DotStyle:
        """Return new style with different z_index."""
        return DotStyle(radius=self.radius, color=self.color, z_index=z_index)
...
class BorderStyle:
    ...
    def with_width(self, width: float) -> BorderStyle:
        """Return new style with different width."""
        return BorderStyle(width=width, color=self.color, z_index=self.z_index)
    
    def with_color(self, color: str) -> BorderStyle:
        """Return new style with different color."""
        return BorderStyle(width=self.width, color=color, z_index=self.z_index)
...
class ShapeStyle:
    ...
    def with_color(self, color: str) -> ShapeStyle:
        """Return new style with different color."""
        return ShapeStyle(color=color, stroke=self.stroke, stroke_width=self.stroke_width, z_index=self.z_index)

    def with_stroke(self, stroke: str | None) -> ShapeStyle:
        """Return new style with different stroke."""
        return ShapeStyle(color=self.color, stroke=stroke, stroke_width=self.stroke_width, z_index=self.z_index)

    def with_stroke_width(self, stroke_width: float) -> ShapeStyle:
        """Return new style with different stroke width."""
        return ShapeStyle(color=self.color, stroke=self.stroke, stroke_width=stroke_width, z_index=self.z_index)

    def with_z_index(self, z_index: int) -> ShapeStyle:
        """Return new style with different z_index."""
        return ShapeStyle(color=self.color, stroke=self.stroke, stroke_width=self.stroke_width, z_index=z_index)
